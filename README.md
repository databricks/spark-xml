...
```
$SPARK_HOME/bin/spark-shell --packages com.databricks:spark-xml_2.11:0.3.5
```
...
Sys.setenv('SPARKR_SUBMIT_ARGS'='"--packages" "com.databricks:spark-xml_2.10:0.3.5" "sparkr-shell"')
...
Sys.setenv('SPARKR_SUBMIT_ARGS'='"--packages" "com.databricks:spark-csv_2.10:0.3.5" "sparkr-shell"')
sqlContext <- sparkRSQL.init(sc)
customSchema <- structType(
