 ...
 */
private[readers] abstract class XmlReader(
    fieldSep: Char = ',',
    lineSep: String = "\n",
    quote: Char = '"',
    escape: Char = '\\',
    ...
    maxCols: Int = 20480) {
  protected lazy val parser: XmlParser = {
    val settings = new XmlParserSettings()
 ...
 * @param maxCols maximum number of columns allowed, for safety against bad inputs
 */
private[xml] class LineXmlReader(
    fieldSep: Char = ',',
    lineSep: String = "\n",
    quote: Char = '"',
    escape: Char = '\\',
   ...
   * @return array of strings where each string is a field in the XML record
   */
 ...
 * @param maxCols maximum number of columns allowed, for safety against bad inputs
 */
private[xml] class BulkXmlReader(
